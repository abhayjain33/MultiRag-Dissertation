...
import { Copy, Download, CheckCircle, AlertCircle, ChevronDown, FileCode2, UploadCloud, Eye, EyeOff, RefreshCw } from 'lucide-react';
import { useStore } from '@/store/agentBuilderStore';
import { toYamlString, fromYamlString, validate, highlightYaml, PRESETS } from '@/lib/yaml';
      ...
      <header className="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-3 flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[10px] text-gray-400 leading-none mt-0.5">config-file-driven AI agents</div>
          </div>
        </div>
