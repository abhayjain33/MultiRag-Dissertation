...
import type { TicketWSEvent } from '@/types/ticket';
...
// In dev/mock mode we skip the WebSocket entirely.
const MOCK_MODE = import.meta.env.VITE_USE_MOCK === 'true' || import.meta.env.DEV;
